...
const MOB_SPRITE = {
  ...
  [KIND.GNOLL]: ['GNOLL1', 'GNOLL2'],
  [KIND.TRICKSTER]: ['TRICKSTER1', 'TRICKSTER2'],
  [KIND.LASHER]: ['LASHER1', 'LASHER2'],
  [KIND.SPINNER]: ['SPINNER1', 'SPINNER2'],
  [KIND.SPARK]: ['SPARK1', 'SPARK2'],
  [KIND.SUCCUBUS]: ['SUCCUBUS1', 'SUCCUBUS2'],
  [KIND.ENGINE]: ['ENGINE1', 'ENGINE2'],
  [KIND.RIPPER]: ['RIPPER1', 'RIPPER2'],
  [KIND.SPAWNER]: ['SPAWNER1', 'SPAWNER2'],
